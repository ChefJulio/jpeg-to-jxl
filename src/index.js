...
async function getModule() {
  ...
  _module = await createModule({
    // Locate the .wasm file relative to this JS file
    locateFile: (path) => {
      const url = new URL(path, import.meta.url);
      // Node.js needs a file path; browsers need a URL string
      if (url.protocol === 'file:') {
        // Convert file:// URL to OS path (handles Windows drive letters too)
